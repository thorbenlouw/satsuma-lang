...
---
# ADR-022: add entry files to example workspaces and update testing prompts

Each example subdirectory needs a clear entry file for the file-based CLI model per ADR-022.
...
For each: identify or create the entry file that imports everything needed. Update examples/README.md to document entry files.
