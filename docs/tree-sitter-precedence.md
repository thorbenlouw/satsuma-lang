# Satsuma Tree-Sitter Precedence Strategy

## Purpose

This note captures the initial precedence and parse-boundary strategy for the
Satsuma Tree-sitter grammar. It is intentionally short and should be updated if the
...
- Preserve statement boundaries with newline-aware parsing where Satsuma requires
...
This mirrors the written Satsuma spec and simplifies formatting later.
