# STM v2 CST Reference

This document describes the concrete syntax tree (CST) produced by the `tree-sitter-stm` v2 grammar. It is the authoritative reference for tool authors querying the CST.
