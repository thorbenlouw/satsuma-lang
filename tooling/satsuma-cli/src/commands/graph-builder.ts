...
export interface FieldEdge {
  ...
  mapping: string;
  /** Arrow classification: "none" | "structural" | "nl" | "mixed" | "nl-derived". */
  classification: string;
  /** Source file containing the arrow. */
  file: string;
  /** 1-based line number. */
  line: number;
  /** Structural transform steps (present for structural/mixed arrows). */
  transforms?: string[];
  /** Raw NL text from quoted pipe steps (present for nl/mixed arrows). */
  nl_text?: string;
